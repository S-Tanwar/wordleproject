const words = [
  ...
  function handleGuess() {
    ...
    if (guess.length !== 5) {
      feedbackMessage.textContent = "Please enter a 5-letter word.";
      return;
    }
    ...
    if (guess === targetWord) {
      ...
      feedbackMessage.textContent = `Game over! The word was: ${targetWord}.`;
      submitButton.disabled = true;
    }
  ...
  // Initialize the board and add event listener to submit button
  createBoard();
